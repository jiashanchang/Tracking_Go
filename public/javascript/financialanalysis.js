...
submitNetMonth.addEventListener("click", monthlyNetList);

// 年結餘
async function yearlyNetList() {
...
submitNetYear.addEventListener("click", yearlyNetList);